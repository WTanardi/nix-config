...
return {
	...
	},
	{
		...
		config = function()
			...
			-- You'll need to install these language servers manually on your system
			-- Examples of how to install some common ones:
			--
			-- Lua: Install lua-language-server from your package manager or GitHub
